...
#set a limit for which the elevation is too great for it not to be an error
    ...
    ##################################################################################################################################################################################################################################################
    #We need to check number of clusters which are greater of a distance than 4, if no clusters are in this parameter then move on to next nothing
    ################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################
    if len(index_list) > 1:
        print('cluster_number')
        #We need the values either side of the points which have been removed.#lets say were looking for 3 points either side
        variance = 3 #how many points either side
        min_update_value = min(index_list) - variance
        max_update_value = max(index_list) + variance
